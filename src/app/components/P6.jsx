        ...
        <div className="lg:w-1/2 p-8  flex flex-col justify-center">
          <div className="">
            ...
            <p className="text-white text-base lg:text-lg leading-relaxed mb-12">
              For Shimaa Beauty Center, we provided complete social media management services 
              that elevated their online presence. From designing high-quality visuals to creating 
              engaging content and planning consistent posting schedules, our goal was to reflect their 
              luxurious brand identity across all platforms. With a focus on audience growth, brand 
              awareness, and client engagement, we helped Shimaa Beauty Center build a strong digital 
              footprint in the beauty industry.
            </p>
            ...
            <div className="flex justify-end">
              ...
              <button 
              onClick={() => {window.open('https://www.instagram.com/shimaamedicalspa/')}}
